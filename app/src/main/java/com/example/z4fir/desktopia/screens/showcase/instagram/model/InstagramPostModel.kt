package com.example.z4fir.desktopia.screens.showcase.instagram.model

import com.example.z4fir.desktopia.screens.showcase.instagram.database.DatabasePost
...
data class NodeResponse(
    ...
    @Json(name = "taken_at_timestamp") val timeStamp: Long,
