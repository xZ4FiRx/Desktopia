...
//TODO Add Moshi version of SerializedName annotation like GSON.
...
data class HashtagResponse(
        @Json(name = "edge_hashtag_to_media") val edgeHashtagToMedia: HashtagToMediaResponse,
...
data class ThumbNailResResponse(
        @Json(name = "config_height") val configHeight: Int,
        @Json(name = "config_width") val configWidth: Int,
